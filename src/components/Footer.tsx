        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          >
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/_ashu_h3r3/" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 border border-white/10 text-white/60 hover:text-white hover:bg-white/10 hover:scale-105 hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all duration-300">
              ...
              <a href="https://www.linkedin.com/in/ashutosh-patel2901/" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 border border-white/10 text-white/60 hover:text-white hover:bg-white/10 hover:scale-105 hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all duration-300">
              ...
              <a href="https://github.com/Ashu8810" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 border border-white/10 text-white/60 hover:text-white hover:bg-white/10 hover:scale-105 hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all duration-300">
          ...
          >
            ...
            <a href="mailto:ashutoshpatel0044@gmail.com" className="text-sm font-medium text-white/70 hover:text-white transition-colors mb-2">
              ashutoshpatel0044@gmail.com
            </a>
